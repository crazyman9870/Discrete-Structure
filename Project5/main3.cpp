...
int main(int argc, char* argv[])
{
	...
	try
	{
		...
		*/
		...
		/*
		 THIS B.PRINT LINE OF CODE WAS WRITING OUT THE RESULTS OF THE PARSER TO THE
		 OUTPUT FILE AND IS NO LONGER NECESSARY BUT IF WANTED YOU COULD UNCOMMENT IT
		 OUT TO WRITE THOSE RESULTS TO THE OUTPUT FILE
		*/
		//b.print(output);

		/*
		 THESE NEXT FEW LINES ARE TO ENSURE THAT THE DATALOG CREATED IN THE PARSER WAS
		 CORRECTLY MOVED INTO THE C DATALOGPROGRAM OBJECT ABOVE. UNCOMMENT THEM TO COUT
		 THE CURRENT DATALOG PROGRAM OBJECT C
		*/
		//c.printSVec(); c.printFVec(); c.printRuleVec(); c.printQVec(); c.printSet();

		Interpreter d;

		Database e = d.mainFxn(c, output);
